...
// Name
// Joseph Zhong is yolo $waggie m4st@rr w0w
// Snake Bug Project
// Snake Bug object for the Snake Game
...
public class SnakeBug extends Bug
{
	...
	public void randomFlower()
	{
		// FILL IN
                Grid<Actor> gr = getGrid();
                Flower f = new Flower();
                f.putSelfInGrid(gr, getRandomEmptyLocation());
	}
	...
	public void eraseTail()
	{
		// FILL IN
            Grid<Actor> gr = getGrid();
            gr.remove(locations.get(locations.size()-1));
